...
build:
	...
	${INFO} "Copying application artifacts to target folder..."
...
tag:
	${INFO} "Tagging relase image with tags $(TAG_ARGS)..."
	@ $(foreach tag, $(TAG_ARGS), docker tag $(IMAGE_ID) $(DOCKER_REGISTRY)/$(ORG_NAME)/$(REPO_NAME):$(tag);)
	${INFO} "Tagging complete"

buildtag:
	${INFO} "Tagging release image with image suffix $(BUILD_TAG) and build tags $(BUILDTAG_ARGS)..."
